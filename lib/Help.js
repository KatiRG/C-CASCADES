...
var Help = Class.create( {
    ...
    {        
        ...
        console.log($( this.parentContainerId ))
        return wrapperDiv;
    },
    ...
    // },
    createTitle: function(arg)
    {
        var titleDiv = $( `<div class="helpOverlayTitle">${arg}</div>` );
        this.wrapper.append( titleDiv );
    },
    ...
    //     this.wrapper.append();
    // },
    createFooter: function(arg)
    {
        const thisFooter = $( `<div class="helpOverlayFooter">${arg}</div>` );
        this.wrapper.append(thisFooter);
    },
    ...
    create: function()
    {
        ...
        // this.createTitle();
        // this.createFooter();
        if (this.helpArray[0].myTitle) this.createTitle(this.helpArray[0].myTitle);
        if (this.helpArray[0].myfooter) this.createFooter(this.helpArray[0].myfooter);
    ...
    createDivHelp: function( element, divTop, divLeft )
    {
        ...
        this.number++;
        var helpDiv = $( "<div class='helpOverlayStyle' id='" + helpId + "' name='" + element.divToHelpId + "'></div>" ).css( {position:"absolute", top:divTop + "px", left:divLeft + "px" } );
